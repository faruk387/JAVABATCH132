...
public class StringManipulations01 {
    public static void main(String[] args) {
        ...
        String s="Alabama";
        //indexOf('a') will give you the index of first occurrence 'a'.
        int idxA=s.indexOf('a');
        System.out.println(idxA);

        //Example 2: Type cpde to find the index of first occurrence of "java" in a given String.
        ...
        int idxMary=t.indexOf("Mary");
        System.out.println(idxMary);
        ...
        //Example 4: Type code to find the index of last occurrence of "earn" in a given String.
        ...
        String y="miami";
        char ch='l';
        boolean isUnique=y.indexOf(ch)==y.lastIndexOf(ch);
        System.out.println("Is character unique? "+isUnique);
        /*
