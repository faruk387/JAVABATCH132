...
public class AnimalRunner {
    public static void main(String[] args) {
        ...
        System.out.println(myCat.age);//14<== Cat class has "age" variable, that is why the object does not use the variable from the parents.
       //When you create an object, you can select data type of the object from the class itself or from any parents
        Object cat0=new Cat();
        ...
        //Strart to look for the method from the class used its constructor
