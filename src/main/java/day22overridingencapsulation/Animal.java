...
public  class Animal {
    ...
    2)We can not touch "Method Signature" in "Method Overriding".
    ...
    11)"Static" method can not be overridden.

    "final" keyword in Java:
    1) "final" keyword can be used for variables.
       if you use final keyword for variables i) You have to initialize ii) After assigning a value you can not update the value.
    2) "final" keyword can be used for classes.
       if you use final keyword for classes, the class cannot have a "Child Class".
    3) "final" keyword can be used for methods.
       if you use final keyword for methods, the method cannot be overridden.
       The body of a "final method" cannot be updated, so it can not be overridden because in overriding we update the method body.
    ...
    What is the difference between them?
         ...
         ii)"private" method cannot be overridden but be can be overloaded.
         ...
         iv)We con not override "static" methods , we can overload them.
         v)other name of "method overloading" is "static polymorphism".
         vi)other name of "method overriding" is "dynamic polymorphism".
         vii)other name of "method overloading" is "compile time polymorphism".
         viii)other name of "method overriding" is "run time polymorphism".
