...
public class Honda implements Ac,Engine{
    /*
        ...
        11) It is allowed to create methods with the same name in different parents interfaces.
            But if you create methods with the same name in different parents interfaces, make "parameters" and "return type" same as well
