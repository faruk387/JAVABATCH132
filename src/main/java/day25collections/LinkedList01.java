...
public class LinkedList01 {
    ...
    public static void main(String[] args) {
        ...
        //retrieves and removes the first element of the lsit
        String f1=names.remove();
        System.out.println(f1);
        System.out.println(names);//[Ali, Brad, Jim, Brad, Brad, Ali]
        //Removes the first occurance of specified element from the list, if it present.
        ...
        //Return elements at the specified position.
        String f2=names.remove(1);
        System.out.println(f2);//Jim
        System.out.println(names);//[Ali, Brad, Brad, Ali]
        //Removes and returns the last element from the list
        String f3=names.removeLast();
        System.out.println(f3);//Ali
        System.out.println(names);//[Ali, Brad, Brad]
        //Removes the last occurance of the specified element in the list
        //If the list does not contain the element,it is unchanged
        //Returns boolean
        boolean r2=names.removeLastOccurrence("Brad");
      ...
      students.add("Ali");
        System.out.println(students);//[Angie, Ali, Brad, Jim, Brad, Brad, Ali]
         //removes and returns the first element on the list.
        //This method is equivalent to removeFirst();.
        //NoSuchElementException-if this list is empty
         students.pop();
        System.out.println(students); //[Ali, Brad, Jim, Brad, Brad, Ali]
        //retrieves and removes the first element on the list
        //Returns the head of the list,or null if the list is empty
        students.poll();
        System.out.println(students);//[Brad, Jim, Brad, Brad, Ali]
        //Retrieves,but does not remove, the first element on the list.(copy+paste)
        //NoSuchElementExeptions-if this list is empty
        ...
        String f4=students.set(0,"John");
        System.out.println(f4);//Brad
        System.out.println(students);//[John, Jim, Brad, Brad, Ali]
