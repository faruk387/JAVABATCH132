...
public class E02 {
    public static void main(String[] args) {
        ...
        System.out.println(getCharacter(s,2));
        System.out.println(getCharacter(s,12));//StringIndexOutOfBoundsException ==> String index out of range: 12
    ...
    public static String getElement(String[] a,int idx){
       try{
           ...
           System.out.println("Do not use values less then 0 or greater then length -1");
           return "";
       }
    ...
    public static char getCharacter(String s,int idx){
       try{
           return s.charAt(idx);
