...
public class CustomExceptionRunner {
    ...
    //Create a method to print student grades, the method will throw exception if the student grade is negative or greater than 100
    public static void studentGrades(int grade) throws IllegalGradeException {
