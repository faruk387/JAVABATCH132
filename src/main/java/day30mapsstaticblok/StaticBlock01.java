...
public class StaticBlock01 {
    ...
    2)Non-static variables I mean Instance or Object variables when you create an Object.
    ...
    4)There  is "instance block" as well
     Instance Block is used if you want to execute some code in all constructors in a class.
