...
public class Lambda01 {
     ...
     */
      public static void main(String[] args) {
          ...
          System.out.println(findMax4(nums));
      ...
      //Example 1)Create a method to print all list elements on the console in the same line with a space among them
    //1.Way:Used "Structured Programming"
    public static void printElement1(List<Integer> myList){
    ...
    public  static void printElemet2(List<Integer>myList){
...
//1.Way:
    ...
    public static int findMinGreaterThanSevenEven(List<Integer> myList){
         return  myList.stream().distinct().filter(t-> t%2==0&&t>7).sorted().findFirst().get();
    }
    ...
    public static int findAnyValueLessThanFifteenEven(List<Integer> myList){
          return myList.stream().distinct().filter(t-> t%2==0&&t<15).findAny().get();
